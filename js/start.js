$(document).ready(() => {
  ...
  $(".button").on("click", () => {
    ...
    localStorage.setItem('bar', val);    //Make sure the input box is not empty before
    //Change screen; display entered name.
    html = `
      <div class="board" id="board">
        <header>
          ...
          <ul>
          <br/>
          <span style="color:black; font-size:1.5rem">${val.toString()}</span>
        <li id='player1'class="players ">
        ...
        <ul class="boxes" id="boxes"><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li>
      <li class="box"></li><li class="box"></li>
        </ul>
      </div>`;

    //Load html to body element
    $("body").html(html);

    //After load set Player-1 as active
