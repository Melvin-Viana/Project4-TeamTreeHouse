$(document).ready(() => {
  //Variabl that holds the html for startup screen.
  var html = `
...
<div class="board" id="board">
  ...
  <ul class="boxes"><li class="box-filled-1"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li><li class="box"></li>
